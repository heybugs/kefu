          ...
          <el-row :gutter="20">
            ...
            <el-col :span="24">
              <el-table :data="item.tableData" style="width: 100%">
                <el-table-column prop="kefu_name" label="客服" width="120">
                </el-table-column>
                <el-table-column prop="call_phone" label="主叫号码" width="120">
                </el-table-column>
                <el-table-column width="120" prop="called_phone" label="被叫号码">
                </el-table-column>
